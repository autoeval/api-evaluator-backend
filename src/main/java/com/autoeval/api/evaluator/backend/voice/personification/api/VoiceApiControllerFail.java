...
public class VoiceApiControllerFail {
    private static final Logger LOGGER = LoggerFactory.getLogger(VoiceApiControllerFail.class);

    @Value("classpath:responses_all_fail.json")
